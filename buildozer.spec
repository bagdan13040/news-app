...
requirements = python3,kivy==2.2.0,kivymd==1.2.0,requests,certifi,charset-normalizer,idna,urllib3,beautifulsoup4,python-dotenv,duckduckgo-search,lxml,httpx,h11,httpcore,anyio,sniffio,trafilatura
